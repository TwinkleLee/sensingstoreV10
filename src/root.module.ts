...
import { SensingStoreCloudCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'SensingStoreCloud',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for SensingStoreCloud'
    });
}
...
export function getSmartDeviceServiceBaseUrl(): string {
...
@NgModule({
    imports: [
        ...
        AppModule,
        SensingStoreCloudCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule
    ...
    providers: [
        ...
        { provide: API_PRODUCT_URL, useFactory:getProductServiceBaseUrl  },
        {
