...
export class ImportBrandFromExcelServiceProxy {
     ...
     * @return Success
     */
    importBrand(fileforBrand: FileParameter | undefined, fileforBrand1: FileParameter | null | undefined): Observable<ImportResultDto> {
...
export class ImportDeviceScheduleServiceProxy {
     ...
     * @return Success
     */
    importDeviceStoreSchduleByExcel(excel: FileParameter | undefined, excel1: FileParameter | null | undefined): Observable<ImportDeviceResultDto> {
...
export class ImportFloorGuideRoomAndStoreServiceProxy {
     ...
     * @return Success
     */
    importBrandAndStoreFromExcel(file: FileParameter | undefined, file1: FileParameter | null | undefined): Observable<ImportResultDto[]> {
     ...
     * @return Success
     */
    importBrandFromExcel(file: FileParameter | undefined, file1: FileParameter | null | undefined): Observable<ImportResultDto> {
     ...
     * @return Success
     */
    importStoreFromExcel(file: FileParameter | undefined, file1: FileParameter | null | undefined): Observable<ImportResultDto> {
...
export class StoreServiceProxy {
     ...
     * @return Success
     */
    addorUpdateStore(body: UpdateStoreInput | undefined): Observable<StoresDto> {
        let url_ = this.baseUrl + "/api/services/app/Store/AddorUpdateStore";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAddorUpdateStore(response: HttpResponseBase): Observable<StoresDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
