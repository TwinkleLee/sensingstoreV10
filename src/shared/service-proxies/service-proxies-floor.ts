...
export class ImportFloorGuideRoomAndStoreServiceProxy {
    ...
    importBrandAndStoreFromExcel(fileforBrandAndStore: FileParameter | undefined, fileforBrandAndStore1: FileParameter | null | undefined): Observable<ImportResultDto[]> {
        ...
        if (fileforBrandAndStore !== null && fileforBrandAndStore !== undefined)
            content_.append("fileforBrandAndStore", fileforBrandAndStore.data, fileforBrandAndStore.fileName ? fileforBrandAndStore.fileName : "fileforBrandAndStore");
    ...
    importStoreFromExcel(fileforStore: FileParameter | undefined, fileforStore1: FileParameter | null | undefined): Observable<ImportResultDto> {
        ...
        const content_ = new FormData();
        if (fileforStore !== null && fileforStore !== undefined)
            content_.append("fileforStore", fileforStore.data, fileforStore.fileName ? fileforStore.fileName : "fileforStore");
...
export class RoomServiceProxy {
     ...
     * @return Success
     */
    getRooms(floorId: string | null | undefined, buildingId: string | null | undefined, roomType: string | null | undefined, storeId: number | null | undefined, filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Observable<RoomDtoPagedResultDto> {
     ...
     * @return Success
     */
    getRoomsNew(floorId: string | null | undefined, buildingId: string | null | undefined, roomType: string | null | undefined, storeId: number | null | undefined, filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Observable<RoomListDtoPagedResultDto> {
...
export class SensingDeviceServiceProxy {
     ...
     * @return Success
     */
    getFloorsDetails(subkey: string | null | undefined, buildingId: string | null | undefined, floorId: string | undefined, filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Observable<SensingFloorDetails1DtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SensingFloorDetails1DtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<SensingFloorDetails1DtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetFloorsDetails(response: HttpResponseBase): Observable<SensingFloorDetails1DtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SensingFloorDetails1DtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SensingFloorDetails1DtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    getFloorsDetailsNew(subkey: string | null | undefined, buildingId: string | null | undefined): Observable<SensingFloorDetailsDto[]> {
        let url_ = this.baseUrl + "/api/services/app/SensingDevice/GetFloorsDetailsNew?";
        if (subkey !== undefined && subkey !== null)
            url_ += "Subkey=" + encodeURIComponent("" + subkey) + "&";
        if (buildingId !== undefined && buildingId !== null)
            url_ += "BuildingId=" + encodeURIComponent("" + buildingId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetFloorsDetailsNew(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetFloorsDetailsNew(<any>response_);
                } catch (e) {
                    return <Observable<SensingFloorDetailsDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<SensingFloorDetailsDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetFloorsDetailsNew(response: HttpResponseBase): Observable<SensingFloorDetailsDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(SensingFloorDetailsDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<SensingFloorDetailsDto[]>(<any>null);
    }
}
...
export class SensingFloorDetails1Dto implements ISensingFloorDetails1Dto {
    navigations!: NavigationDto[] | undefined;
    id!: string;
    tenantId!: number;
    buildingId!: string;
    ...
    constructor(data?: ISensingFloorDetails1Dto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SensingFloorDetails1Dto {
        data = typeof data === 'object' ? data : {};
        let result = new SensingFloorDetails1Dto();
        result.init(data);
        return result;
    }
...
export interface ISensingFloorDetails1Dto {
    navigations: NavigationDto[] | undefined;
    id: string;
    tenantId: number;
    buildingId: string;
...
export class SensingFloorDetails1DtoPagedResultDto implements ISensingFloorDetails1DtoPagedResultDto {
    totalCount!: number;
    items!: SensingFloorDetails1Dto[] | undefined;

    constructor(data?: ISensingFloorDetails1DtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(SensingFloorDetails1Dto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): SensingFloorDetails1DtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new SensingFloorDetails1DtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface ISensingFloorDetails1DtoPagedResultDto {
    totalCount: number;
    items: SensingFloorDetails1Dto[] | undefined;
}
