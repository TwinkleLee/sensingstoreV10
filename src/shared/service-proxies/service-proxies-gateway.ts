...
@Injectable()
export class DeviceMirrorPublishServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;

    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_GATEWAY_URL) baseUrl?: string) {
        this.http = http;
    ...
    publishDeviceMirror(body: DeviceMirrorPublishInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/DeviceMirrorPublish/PublishDeviceMirror";
        url_ = url_.replace(/[?&]$/, "");
