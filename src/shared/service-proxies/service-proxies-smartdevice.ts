...
export class AppPodServiceProxy {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_SMARTDEVICE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "http://119.3.154.130:8004";
    }
...
export class CustomizeReportServiceProxy {
     ...
     * @return Success
     */
    addOrUpdateReportTemplate(body: AddOrUpdateReportTemplateInput | undefined): Observable<void> {
...
export class SensorAgreementServiceProxy {
     ...
     * @return Success
     */
    postSensorAgreementFile(postFile: FileParameter | undefined): Observable<void> {
        ...
        if (postFile === null || postFile === undefined)
            throw new Error("The parameter 'postFile' cannot be null.");
        else
