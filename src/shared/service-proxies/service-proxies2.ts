...
export class SensingShopServiceProxy {
     ...
     * @return Success
     */
    getwxPayResult(tenantId: number | null | undefined, memberId: number | null | undefined, orderId: number | null | undefined): Observable<boolean> {
    ...
    protected processGetwxPayResult(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
