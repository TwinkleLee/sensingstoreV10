...
export class DateMetaPhysicsServiceProxy {
    ...
    protected processGetDateMetaphysicsList(response: HttpResponseBase): Observable<PagedResultDtoOfDateMetaphysicsListDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDateMetaphysicsListDto.fromJS(resultData200) : new PagedResultDtoOfDateMetaphysicsListDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processGetDateMetaPhysics(response: HttpResponseBase): Observable<DateMetaphysicsDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? DateMetaphysicsDto.fromJS(resultData200) : new DateMetaphysicsDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processCreateRecommend(response: HttpResponseBase): Observable<RecommendDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? RecommendDto.fromJS(resultData200) : new RecommendDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processGetDateMetaphysicsBySubkey(response: HttpResponseBase): Observable<PagedResultDtoOfDateMetaphysicsDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDateMetaphysicsDto.fromJS(resultData200) : new PagedResultDtoOfDateMetaphysicsDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class FaceTagsServiceProxy {
    ...
    protected processGetTagRecommendsBySubkey(response: HttpResponseBase): Observable<FaceTagsRecommendsDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? FaceTagsRecommendsDto.fromJS(resultData200) : new FaceTagsRecommendsDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processGetFaceTagList(response: HttpResponseBase): Observable<PagedResultDtoOfFaceTagDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfFaceTagDto.fromJS(resultData200) : new PagedResultDtoOfFaceTagDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processGetFaceTagById(response: HttpResponseBase): Observable<FaceTagDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? FaceTagDto.fromJS(resultData200) : new FaceTagDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class MetaPhysicsServiceProxy {
    ...
    protected processGetMetaPhysicsList(response: HttpResponseBase): Observable<PagedResultDtoOfMetaPhysicsDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfMetaPhysicsDto.fromJS(resultData200) : new PagedResultDtoOfMetaPhysicsDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processUpdateMetaphysics(response: HttpResponseBase): Observable<MetaPhysicsDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? MetaPhysicsDto.fromJS(resultData200) : new MetaPhysicsDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processGetHostMetaphysicsTypes(response: HttpResponseBase): Observable<PagedResultDtoOfMetaphysicsTypeDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfMetaphysicsTypeDto.fromJS(resultData200) : new PagedResultDtoOfMetaphysicsTypeDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processUpdateMetaphysicsType(response: HttpResponseBase): Observable<MetaphysicsTypeDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? MetaphysicsTypeDto.fromJS(resultData200) : new MetaphysicsTypeDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class GetImportDateMetaPhysicsInput implements IGetImportDateMetaPhysicsInput {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.metaPhysicsId = data["metaPhysicsId"];
...
export class DateMetaphysicsListDto implements IDateMetaphysicsListDto {
    ...
    init(data?: any) {
        if (data) {
            this.metaphysicsId = data["metaphysicsId"];
            this.metaphysicsName = data["metaphysicsName"];
            this.date = data["date"] ? moment(data["date"].toString()) : <any>undefined;
            if (data["lucks"] && data["lucks"].constructor === Array) {
                this.lucks = [] as any;
                for (let item of data["lucks"])
                    this.lucks!.push(LuckDto.fromJS(item));
            }
            this.typeName = data["typeName"];
            this.extensionData = data["extensionData"];
            this.from = data["from"];
            this.fromLogoUrl = data["fromLogoUrl"];
    ...
    toJSON(data?: any) {
        ...
        if (this.lucks && this.lucks.constructor === Array) {
            data["lucks"] = [];
...
export class LuckDto implements ILuckDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.numberPresummary = data["numberPresummary"];
            this.color = data["color"];
            this.colorPresummary = data["colorPresummary"];
            this.direction = data["direction"];
            this.directionPresummary = data["directionPresummary"];
            this.summary = data["summary"];
            this.summaryPresummary = data["summaryPresummary"];
            this.love = data["love"];
            this.lovePresummary = data["lovePresummary"];
            this.career = data["career"];
            this.careerPresummary = data["careerPresummary"];
            this.fortune = data["fortune"];
            this.fortunePresummary = data["fortunePresummary"];
            this.health = data["health"];
            this.healthPresummary = data["healthPresummary"];
            this.bestMatch = data["bestMatch"];
            this.keyword = data["keyword"];
            this.dateMetaphysicsId = data["dateMetaphysicsId"];
            this.lastModificationTime = data["lastModificationTime"] ? moment(data["lastModificationTime"].toString()) : <any>undefined;
            this.lastModifierUserId = data["lastModifierUserId"];
            this.creationTime = data["creationTime"] ? moment(data["creationTime"].toString()) : <any>undefined;
            this.creatorUserId = data["creatorUserId"];
...
export class DateMetaphysicsDto implements IDateMetaphysicsDto {
    ...
    init(data?: any) {
        if (data) {
            this.tenantId = data["tenantId"];
            this.metaphysicsId = data["metaphysicsId"];
            this.metaPhysics = data["metaPhysics"] ? MetaPhysicsDto.fromJS(data["metaPhysics"]) : <any>undefined;
            this.date = data["date"] ? moment(data["date"].toString()) : <any>undefined;
            if (data["lucks"] && data["lucks"].constructor === Array) {
                this.lucks = [] as any;
                for (let item of data["lucks"])
            ...
            if (data["recommneds"] && data["recommneds"].constructor === Array) {
                this.recommneds = [] as any;
                for (let item of data["recommneds"])
    ...
    toJSON(data?: any) {
        ...
        if (this.recommneds && this.recommneds.constructor === Array) {
            data["recommneds"] = [];
...
export class MetaPhysicsDto implements IMetaPhysicsDto {
    ...
    init(data?: any) {
        if (data) {
            this.tenantId = data["tenantId"];
            this.typeId = data["typeId"];
            this.type = data["type"] ? MetaphysicsTypeDto.fromJS(data["type"]) : <any>undefined;
            this.name = data["name"];
...
export class FaceTagsRecommendsDto implements IFaceTagsRecommendsDto {
    ...
    init(data?: any) {
        if (data) {
            if (data["recommends"] && data["recommends"].constructor === Array) {
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (this.recommends && this.recommends.constructor === Array) {
            data["recommends"] = [];
...
export class FaceTagListDto implements IFaceTagListDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.happinessRange = data["happinessRange"];
            this.beautyScoreRange = data["beautyScoreRange"];
            this.extensionData = data["extensionData"];
