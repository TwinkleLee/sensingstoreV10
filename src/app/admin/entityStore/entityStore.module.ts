...
import { EntityStoreRoutingModule } from './entityStore-routing.module';
...
import { CreateOrEditStoreModalComponent } from '@app/admin/entityStore/entity-store/operation/create-or-edit-store-modal.component';
