...
import { ApplyServiceProxy, AuditApplyFormInput, ApplyStatus as AuditApplyFormInputApplyStatus } from '@shared/service-proxies/service-proxies-ads';
...
@Component({
  ...
  templateUrl: './ads-review.component.html',
  styleUrls: ['./ads-review.component.css'],
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()]
})
export class AdsReviewComponent extends AppComponentBase {
  ...
  @ViewChild('adsDetailModal',{static:true}) adsDetailModal: AdsDetailModalComponent;
  ...
  //查看详情
  goDetail(record) {
      this.adsDetailModal.show(record.id);
  }
  //通过
  agree(record) {
