...
@Component({
    selector: 'createOrEditLikeModal',
    templateUrl: './create-or-edit-like-modal.component.html',
...
export class CreateOrEditLikeModalComponent extends AppComponentBase {
    ...
    constructor(injecor:Injector,private likeService:LikeInfoServiceProxy){
        super(injecor);
    }
    //获取skus
