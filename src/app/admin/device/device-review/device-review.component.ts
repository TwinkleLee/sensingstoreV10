...
@Component({
  selector: 'app-device-review',
  templateUrl: './device-review.component.html',
  styleUrls: ['./device-review.component.css'],
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()]
})
export class DeviceReviewComponent extends AppComponentBase {
  ...
  //查看详情
  goDetail(record){
      this.deviceDetailModal.show(record.id);
  }
  //通过
  agree(record){
