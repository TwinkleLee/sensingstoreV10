...
import { AwardType,ActivityServiceProxy,AwardMessageSettingsInput, AwardServiceProxy, SpecialUserServiceProxy, AwardSettingsDto, HtmlTemplateServiceProxy, AwardMessageSettingsDto, TemplateEnum, SpecailUserDtoType } from '@shared/service-proxies/service-proxies5';
...
export class ActivityPrizeComponent extends AppComponentBase {
  ...
  messageBusy = false;
  AwardType = AwardType;
  SpecialType = SpecailUserDtoType;
