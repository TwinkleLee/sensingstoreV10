    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Software', 'Pages.Softwares', 'icon-app', '', [], [
                new AppMenuItem('App', 'Pages.Softwares', 'icon-app', '/app/software/software'),
                new AppMenuItem('AppPod', 'Pages.Administration.Host.AppPod', 'icon-yemian', '/app/apppod/apppod'),
            ]),
            ...
            new AppMenuItem('Recommend', 'Pages.Tenant.Recommends', 'icon-tuijian1', '', [], [
                new AppMenuItem('PersonalRecommend', 'Pages.Tenant.Recommends', 'icon-tuijian', '/app/recommend/recommend'),
                new AppMenuItem('PersonalCategory', 'Pages.Tenant.Recommends', 'icon-fenlei1', '/app/recommend/personalCategory'),
                new AppMenuItem('FaceRecommend', 'Pages.Tenant.Recommends', 'icon-renlianshibie', '/app/recommend/faceRecommend')
            ]),
            ...
            new AppMenuItem('System', 'Pages.Administration', 'icon-jichushezhi', '', [], [
                ...
                new AppMenuItem('PublicAccount', 'Pages.Tenant.PublicAccount', 'icon-gongzhonghao', '/app/publicaccount/publicaccount'),
